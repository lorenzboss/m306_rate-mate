  ...
  return (
    <div className="flex flex-1 items-center justify-center bg-gradient-to-br from-blue-50 to-white p-4 text-gray-800">
      <div className="mx-auto w-full max-w-md rounded-lg border border-gray-200 bg-white p-8 shadow-xl">
        <h1 className="mb-6 text-center text-3xl font-bold text-indigo-900">Welcome Back</h1>
        ...
        {errorMsg && (
          <div className="mb-4 rounded-md border border-red-300 bg-red-100 p-3 text-red-700">
            <p className="flex items-start">
              <svg className="mt-0.5 mr-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <form className="flex flex-col space-y-5" onSubmit={handleSubmit}>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              >
                {showPassword ? (
                  <svg className="h-5 w-5 text-gray-500 hover:text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-6 border-t border-gray-200 pt-5">
          <p className="text-center text-xs text-gray-500">
            ...
            <a href="#" className="text-blue-600 underline hover:text-blue-700">Terms of Service</a> and{" "}
